...
module GeneratedUrlHelpersModule
  ...
  def api_book_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_books_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_genre_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_genres_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_api_book_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_api_genre_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_rails_conductor_inbound_email_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def new_api_book_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def new_api_genre_url(*args); end
