...
module GeneratedPathHelpersModule
  ...
  def api_book_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_books_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_genre_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_genres_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_api_book_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_api_genre_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_rails_conductor_inbound_email_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def new_api_book_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def new_api_genre_path(*args); end
